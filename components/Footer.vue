...
<footer class=" w-full py-4 bg-white md:px-6 md:py-8 dark:bg-gray-900">
  <div class="sm:flex sm:items-center sm:justify-between">
    ...
    <ul class="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
      <li>
        <NuxtLink href="/" class="mr-4 hover:underline md:mr-6 ">Home</NuxtLink>
      </li>
      <li>
  ...
  <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://sergioej.dev/" class="hover:underline">Sergio Esteve™</a>. All Rights Reserved.
  </span>
</footer>
